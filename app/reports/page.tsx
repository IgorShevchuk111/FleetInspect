...
// import { getAllInspections } from '@/app/_lib/data_servis';
// import {
//   ChartBarIcon,
//   ClockIcon,
...
//   const vehicleTypes = filteredInspections.reduce(
//     (acc, inspection) => {
...
//   // Trip type breakdown
//   const tripTypes = filteredInspections.reduce(
//     (acc, inspection) => {
...
//   const inspectorStats = filteredInspections.reduce(
//     (acc, inspection) => {
...
export default async function ReportsPage() {
  ...
  // Supabase auth (заміна auth helper)
  const {
    data: { user },
