        ...
        if (inspectionId) {
          ...
          inspectionForm.forEach((formField) => {
            if ((formField as any).type === 'checkbox') {
              initialItems[(formField as any).name] =
                inspection[(formField as any).name];
            }
          });
          ...
          inspectionForm.forEach((formField) => {
            if ((formField as any).type === 'time') {
              ...
              if (inspection[timeField]) {
                initialTimeValues[(formField as any).name] =
                  inspection[timeField];
              }
            }
          });
          ...
          inspectionForm.forEach((formField) => {
            if ((formField as any).type === 'number') {
              ...
              if (inspection[numberField]) {
                initialNumberValues[(formField as any).name] =
                  inspection[numberField];
              }
            }
          });
          ...
          inspectionForm.forEach((formField) => {
            if ((formField as any).type === 'checkbox') {
              ...
              if (inspection[photoField] && inspection[photoField].length > 0) {
                initialImages[(formField as any).name] = inspection[
                  photoField
                ].map((url: string) => ({
